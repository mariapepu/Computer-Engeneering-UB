...
template<class X>
int MaxHeap<X>::parentPos(int knoten){ int vaterPos; return vaterPos(knoten % 2 == 0)? vaterPos((knoten - 2)/ 2 < 0)? 0 : (knoten - 2)/ 2 : vaterPos((knoten - 1)/ 2 < 0)? 0 : (knoten -1)/ 2;}
